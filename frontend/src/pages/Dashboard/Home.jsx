        ...
        {loading ? <Loader /> : (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm" id="recent-transactions">
              ...
              <div className="bg-white p-10 rounded-2xl border border-gray-100 shadow-sm" id="financial-overview">
